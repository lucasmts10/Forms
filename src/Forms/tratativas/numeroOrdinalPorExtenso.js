...
// eslint-disable-next-line
 Number.prototype.toOrdinal = function (opt) {
    ...
    if (this < 100 && this > 9) {
        let x = ["", `décim${g}`, "vig", "trig", "quadrag", "quinquag", "sexag", "septuag",
            "octog", "nonag"]
...
/*
     Créditos: Gabriel Coutinho | gcacoutinho | https://github.com/gcacoutinho/ordinal-pt-br
*/ 