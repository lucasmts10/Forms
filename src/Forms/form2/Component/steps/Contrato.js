...
export const initialValuesContract = {
    ufContrato: '',
    cidadeContrato: '',
    dataIniContrato: ''
};

export const validationContract = Yup.object().shape({
    ufContrato: Yup.string()
        .required('Campo obrigatório'),
    cidadeContrato: Yup.string()
        .required('Campo obrigatório'),
    dataIniContrato: Yup.date()
        .required('Campo obrigatório')
});
